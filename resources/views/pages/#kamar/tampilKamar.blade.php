...
<div class="content-wrapper">
  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
      ...
      <div class="card">
        <div class="card-body">
          <form action="{{ route('updateKamar', $id_kode_kamar) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label">Kode Kamar</label>
              <input type="text" name="id_kode_kamar" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value ={{ $data_kamar->id_kode_kamar }}>
            </div>
            <div class="mb-3">
