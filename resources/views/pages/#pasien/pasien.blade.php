                                            ...
                                            <table id="example1" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    @php
                                                        $no = 1;
                                                    @endphp
                                                    @foreach ($id_kode_pasien as $key)
                                                        <tr>
                                                            <th scope="row">{{ $no++ }}</th>
                                                            <td>{{ $key->id_kode_pasien }}</td>
                                                            ...
                                                            <td>{{ $key->gol_darah }}</td>
                                                            <td>
                                                                <a href="{{ route ('editPasien', $key->id_kode_pasien) }}" class="btn btn-info btn-sm mx-1">
                                                                    <i class="fas fa-edit"></i>
                                                                </a>
                                                                    <form action="{{ route('deletePasien', $key->id_kode_pasien) }}" method="post" class="d-inline">
                                                                        @method('delete')
                                                                        @csrf
